...
void append_page_footer(){ // Saves repeating many lines of code for HTML page footers
  webpage += F("<ul>");
  webpage += F("<li><a href='/'>Anasayfa</a></li>"); // Lower Menu bar command entries
  webpage += F("<li><a href='/indirme'>Download</a></li>"); 
  webpage += F("<li><a href='/dosya yukle'>Upload</a></li>"); 
  webpage += F("<li><a href='/...'>Stream</a></li>"); 
  webpage += F("<li><a href='/dosyayı sil'>Delete</a></li>"); 
  webpage += F("<li><a href='/dosyalar'>Directory</a></li>");
  webpage += F("</ul>");
